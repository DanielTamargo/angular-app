...
export class GitHubTestHelper<T> {
  ...
  /* MOCKED CONSTANTS */
  public static githubUser: GitHubUserInterface = {
    login: "DanielTamargo",
    id: 32647764,
  ...
  public static githubRepos: GitHubRepoInterface[] = [
    {
      id: 478032792,
  ...
  public static githubGists: GitHubGistInterface[] = [
    {
  ...
  public static githubRepoContributors: any[] = [
    {
      "login": "DanielTamargo",
      "id": 32647764,
      "node_id": "MDQ6VXNlcjMyNjQ3NzY0",
